...
function Component(props){
    ...
    const update = (type, job) => {
        fetch(`https://${process.env.REACT_APP_HOST}/friday/`, {
            method:"POST",
            headers: {
                "Content-Type":"application/json"
            },
            body: JSON.stringify({ "type":type, "job":job })
        })
        .then(data => data.json())
        .then(data => {
            console.log(data)
        ...
        switch(type){
            case "wins":
                if(job === "+") return props.Friday.Today.addWin();
                else return props.Friday.Today.removeWin();
            case "losses":
                if(job === "+") return props.Friday.Today.addLoss();
        ...
        <div className="bg-secondary flex flex-col w-full h-full">
            ...
            <div className="p-2 flex justify-around w-full">
                <div className="flex-1 p-2">
                    ...
                    <button onClick={e => update("wins", "+")} className="transition duration-500 ease-in-out bg-other hover:bg-green-600 rounded w-full shadow p-2 flex justify-center items-center mt-2">
                    ...
                    <button onClick={e => update("wins", "-")} className="transition duration-500 ease-in-out bg-other hover:bg-red-600 rounded w-full shadow p-2 flex justify-center items-center mt-4">
                        <svg className="text-default" height="25" viewBox="0 0 21 21" width="25" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex-1 p-2">
                    <hr className="w-full mb-4"/>
                    <button onClick={e => update("losses", "+")} className="transition duration-500 ease-in-out bg-other hover:bg-green-600 rounded w-full shadow p-2 flex justify-center items-center mt-2">
                        <svg className="text-default" height="25" viewBox="0 0 21 21" width="25" xmlns="http://www.w3.org/2000/svg">
                            <g className="stroke-current" fill="none" fillRule="evenodd" stroke="#2a2e3b" strokeLinecap="round" strokeLinejoin="round" transform="translate(2 3)"><path d="m8 16c4.4380025 0 8-3.5262833 8-7.96428571 0-4.43800246-3.5619975-8.03571429-8-8.03571429-4.43800245 0-8 3.59771183-8 8.03571429 0 4.43800241 3.56199755 7.96428571 8 7.96428571z"/><path d="m4 8h8"/><path d="m8 12.0563492v-8.0563492z"/></g>
                        </svg>
                    </button>
                    <button onClick={e => update("losses", "-")} className="transition duration-500 ease-in-out bg-other hover:bg-red-600 rounded w-full shadow p-2 flex justify-center items-center mt-4">
                        <svg className="text-default" height="25" viewBox="0 0 21 21" width="25" xmlns="http://www.w3.org/2000/svg">
                            <g className="stroke-current" fill="none" fillRule="evenodd" stroke="#2a2e3b" strokeLinecap="round" strokeLinejoin="round" transform="translate(2 3)"><path d="m8 16c4.4380025 0 8-3.5262833 8-7.96428571 0-4.43800246-3.5619975-8.03571429-8-8.03571429-4.43800245 0-8 3.59771183-8 8.03571429 0 4.43800241 3.56199755 7.96428571 8 7.96428571z"/><path d="m4 8h8"/></g>
                        </svg>
                    </button>
