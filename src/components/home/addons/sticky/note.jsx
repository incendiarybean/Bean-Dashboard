...
function Component(props){
    ...
    return (
        <div drag="true" id={props.data._id} style={{"top":props.data.top, "left":props.data.left}} className={`note animate__animated animate__fadeIn shadow-lg absolute min-w-56 max-w-96 rounded-lg bg-${props.data.color}-400`}>
            ...
            <div id="note_content" onKeyUp={e => props.Notes.logChange(e, props.data)} className="note p-2" contentEditable="true" dangerouslySetInnerHTML={{__html: decodeURIComponent(props.data.content)}} suppressContentEditableWarning={true}></div>
        </div>
    );
